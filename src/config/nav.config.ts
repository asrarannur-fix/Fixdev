...
export const OPERATIONAL_MODULES: NavModule[] = [
  ...
  },
  {
    ...
    subtabs: [
      ...
      { id: "warranty-claims", label: "Warranty", icon: ShieldCheck },
      { id: "qr-tracker", label: "QR Tracker", icon: QrCode },
      { id: "qc-scoring", label: "QC Scoring", icon: Star },
    ],
  },
  {
    id: "pos",
  ...
  },
  {
    ...
    subtabs: [
      ...
      { id: "cannibal", label: "Kanibal", icon: Layers },
  ...
  },
  {
    ...
    subtabs: [
      ...
      { id: "payroll", label: "Penggajian", icon: CreditCard },
      { id: "contracts", label: "Data Karyawan", icon: ClipboardCheck },
      { id: "performance", label: "Evaluasi", icon: TrendingUp },
