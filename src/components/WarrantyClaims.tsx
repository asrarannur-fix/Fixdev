                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <span className="px-2 py-0.5 rounded-md bg-slate-100 dark:bg-zinc-900 text-slate-700 dark:text-zinc-300 font-mono text-[9px] font-black">
                          {w.ticketNo}
                        </span>
                    ...
                    <div className="bg-slate-50 dark:bg-zinc-950 p-3 rounded-xl text-xs space-y-1.5 border border-slate-100 dark:border-zinc-900">
                    ...
                    <div className="space-y-1.5 text-xs">
                      ...
                      <div className="w-full bg-slate-100 dark:bg-zinc-900 rounded-full h-2 overflow-hidden">
                        <div
                    ...
                    <div className="pt-2 border-t border-slate-100 dark:border-zinc-800 flex gap-2">
                      <button
                        ...
                        className="flex-1 bg-blue-50 hover:bg-blue-100 dark:bg-zinc-900 dark:hover:bg-zinc-800 text-blue-700 dark:text-blue-400 font-black text-xs py-2 rounded-xl border border-blue-200 dark:border-zinc-700 transition text-center cursor-pointer flex items-center justify-center gap-1.5"
                      >
