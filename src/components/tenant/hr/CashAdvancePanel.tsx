...
export const CashAdvancePanel: React.FC<any> = ({ employees, currentTenantId, currentBranchId, setNewKasbonEmpId, setNewKasbonAmount, setNewKasbonReason, setShowAddKasbonModal, setKasbonToApprove, accounts, setSelectedKasbonSource, approveCashAdvance, currentUser }) => (
