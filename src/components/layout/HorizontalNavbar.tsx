...
export const HorizontalNavbar: React.FC<HorizontalNavbarProps> = ({
    ...
    () => [
      {
        ...
        activeColor: 'bg-blue-500 text-white dark:bg-blue-600 shadow-blue-500/10',
        subtabs: [
          {
            id: 'saas-dashboard',
      ...
      },
      {
        ...
        activeColor: 'bg-purple-600 text-white dark:bg-purple-500 shadow-purple-500/10',
      ...
      },
      {
        ...
        activeColor: 'bg-emerald-600 text-white dark:bg-emerald-500 shadow-emerald-500/10',
        subtabs: [{ id: 'saas-billing', label: 'Billing & QRIS', icon: CreditCard }],
      },
      {
        id: 'saas-operations',
        label: 'Operasional',
      ...
      },
      {
        ...
        activeColor: 'bg-amber-500 text-white dark:bg-amber-600 shadow-amber-500/10',
        subtabs: [{ id: 'saas-audits', label: 'Audit Trails', icon: FolderLock }],
      },
    ],
    []
  );
  ...
  const isSubmenuAllowed = (modId: string, subId: string) => {
    ...
    if (modId === 'settings') {
      ...
      if (isOwner || currentUser.role === 'ADMIN' || currentUser.role === 'SUPER_ADMIN') {
        return true;
      }
    }
    ...
    if (isSuperAdmin) {
      return [
        ...superAdminModules,
        {
          ...
          activeColor: 'bg-accent text-white dark:bg-indigo-500 shadow-accent/10',
          subtabs: [],
        },
        {
          id: 'mobile-sim',
          ...
          activeColor: 'bg-slate-700 text-white dark:bg-slate-600 shadow-slate-500/10',
          subtabs: [],
        },
      ];
    }
