...
router.get(
  ...
  requireSuperAdminPermission('tenants:view_invitations'),
  listInvitations
);
...
router.get(
  '/notifications',
  requireSuperAdminPermission('platform:view_notifications'),
  listNotifications
);
router.get('/outbox', requireSuperAdminPermission('platform:view_outbox'), listOutbox);
router.get(
  '/alert-settings',
  requireSuperAdminPermission('platform:view_alerts'),
  getAlertSettings
);
...
router.get(
  '/users',
  requireSuperAdminPermission('users:view_superadmin_users'),
  listSuperAdminUsers
);
...
router.post(
  ...
  requireSuperAdminPermission('platform:manage_console_session'),
  startConsoleSession
);
router.post(
  '/console-session/:id/end',
  requireSuperAdminPermission('platform:manage_console_session'),
  endConsoleSession
);
