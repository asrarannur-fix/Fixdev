        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl outline-none focus:border-accent text-xs font-medium"
            />
          </div>
          <div>
            <label className="block text-[10px] font-mono text-slate-500 uppercase mb-1">
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl outline-none focus:border-accent text-xs font-semibold text-slate-800"
            >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl outline-none focus:border-accent text-xs font-mono font-bold"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl outline-none focus:border-accent text-xs font-medium font-sans"
            />
          </div>
        </div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg font-bold flex items-center gap-1 transition-all text-[11px] cursor-pointer ${
                      isWfActive
                        ? "bg-accent-lighter hover:bg-indigo-100 text-accent border border-indigo-100"
                        : "bg-slate-100 text-slate-400 cursor-not-allowed"
                    }`}
                  >
                    <Play className="w-3 h-3 text-accent fill-indigo-600" />{" "}
                    Uji Alur
                  </button>
                  <button
                    onClick={async () => {
