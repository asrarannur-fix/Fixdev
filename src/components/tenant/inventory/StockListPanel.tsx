...
import { AlertCircle, Plus, PlusCircle, Pencil } from "lucide-react";
import { InventoryProduct, Warehouse, ItemGrade } from "../../../types";
...
interface StockListPanelProps {
  ...
  addProdName: string;
  setAddProdName: (value: string) => void;
  addProdSku: string;
  setAddProdSku: (value: string) => void;
  addProdBarcode: string;
  setAddProdBarcode: (value: string) => void;
  addProdCategory: string;
  setAddProdCategory: (value: string) => void;
  addProdPurchaseCost: string;
  setAddProdPurchaseCost: (value: string) => void;
  addProdSellPrice: string;
  setAddProdSellPrice: (value: string) => void;
  addProdStockQty: string;
  setAddProdStockQty: (value: string) => void;
  addProdMinStock: string;
  setAddProdMinStock: (value: string) => void;
  addProdUnit: string;
  setAddProdUnit: (value: string) => void;
  addProdBranchId: string;
  setAddProdBranchId: (value: string) => void;
  addProdWarehouseId: string;
  setAddProdWarehouseId: (value: string) => void;
  addProdStorageLocId: string;
  setAddProdStorageLocId: (value: string) => void;
  isEditProductOpen: boolean;
  setIsEditProductOpen: (value: boolean) => void;
  selectedEditProduct: InventoryProduct | null;
  setSelectedEditProduct: (value: InventoryProduct | null) => void;
  editProdName: string;
  setEditProdName: (value: string) => void;
  editProdSku: string;
  setEditProdSku: (value: string) => void;
  editProdPurchaseCost: string;
  setEditProdPurchaseCost: (value: string) => void;
  editProdSellPrice: string;
  setEditProdSellPrice: (value: string) => void;
  editProdStockQty: string;
  setEditProdStockQty: (value: string) => void;
  editProdMinStock: string;
  setEditProdMinStock: (value: string) => void;
  editProdWarehouseStock: Record<string, string>;
  setEditProdWarehouseStock: React.Dispatch<React.SetStateAction<Record<string, string>>>;
  editProdStorageLocId: string;
  setEditProdStorageLocId: (value: string) => void;
  expandedProductIds: Set<string>;
  setExpandedProductIds: (value: Set<string>) => void;
}

export const StockListPanel: React.FC<StockListPanelProps> = ({
  tenantProducts, warehouses, pendingPartRequests, currentTenantId, currentBranchId, tenantWhs, branches,
  getBranchStock, showToast, showConfirm, addInventoryProduct, updateInventoryProduct, updateServiceTicket,
  isAddProductOpen, setIsAddProductOpen, addProdName, setAddProdName, addProdSku, setAddProdSku, addProdBarcode, setAddProdBarcode,
  addProdCategory, setAddProdCategory, addProdPurchaseCost, setAddProdPurchaseCost, addProdSellPrice, setAddProdSellPrice,
  addProdStockQty, setAddProdStockQty, addProdMinStock, setAddProdMinStock, addProdUnit, setAddProdUnit,
  addProdBranchId, setAddProdBranchId, addProdWarehouseId, setAddProdWarehouseId, addProdStorageLocId, setAddProdStorageLocId,
  isEditProductOpen, setIsEditProductOpen, selectedEditProduct, setSelectedEditProduct, editProdName, setEditProdName,
  editProdSku, setEditProdSku, editProdPurchaseCost, setEditProdPurchaseCost, editProdSellPrice, setEditProdSellPrice,
  editProdStockQty, setEditProdStockQty, editProdMinStock, setEditProdMinStock, editProdWarehouseStock, setEditProdWarehouseStock,
  editProdStorageLocId, setEditProdStorageLocId, expandedProductIds, setExpandedProductIds,
}) => (
                      ...
                      <tr key={p.id} className="hover:bg-slate-50">
                        ...
                        <td className="px-4 py-3.5">
                          <div className="flex flex-wrap gap-1">
                            ...
                            {p.itemType === "MICRO_COMPONENT" && <span className="px-2 py-0.5 rounded bg-amber-100 text-amber-800 font-bold text-[9px] font-mono uppercase">Komponen Mikro</span>}
                            {p.itemType === "SERVICE_PART" && <span className="px-2 py-0.5 rounded bg-accent-lighter text-accent font-bold text-[9px] font-mono uppercase">Part Servis</span>}
                          </div>
                        </td>
                        ...
                        <td className="px-4 py-3.5 text-right">
                          <Badge variant={(p.category !== "JASA" && getBranchStock(p) <= p.minStock) ? "danger" : "success"}>
                            {(p.category !== "JASA" && getBranchStock(p) <= p.minStock) ? "REORDER ALERT" : "STABLE"}
                          </Badge>
                        </td>
                        <td className="px-4 py-3.5 text-right">
                          <button
