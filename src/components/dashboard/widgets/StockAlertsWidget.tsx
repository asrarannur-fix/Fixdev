  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
    ...
    <div className="bg-gradient-to-br from-sky-50 to-blue-50 dark:from-sky-950/20 dark:to-blue-950/20 rounded-2xl p-3 border border-sky-100 dark:border-sky-900/30 shadow-sm relative overflow-hidden">
      ...
      <div className="relative">
        ...
        <p className="text-[9px] font-bold text-sky-600 dark:text-sky-400 uppercase tracking-wider mb-0.5">Transfer Stok Hari Ini</p>
        <p className="text-lg font-black text-sky-800 dark:text-sky-200">0</p>
      </div>
    </div>
  </div>
);
