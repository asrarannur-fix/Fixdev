            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              {proactiveSuggestions.length > 0 && (
                <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-l-4 border-amber-500 rounded-r-xl p-5 shadow-xs space-y-3 dark:from-slate-900 dark:to-slate-800 dark:border-amber-600">
                  ...
                  <p className="text-[11px] text-amber-700 dark:text-amber-400">
                    Sistem kami mendeteksi bahwa beberapa cabang mengalami kekurangan stok untuk
                    produk tertentu, sementara cabang lain memiliki persediaan berlebih. Ambil
                    tindakan cepat untuk menyeimbangkan stok di bawah ini:
                  </p>
                    ...
                    <div className="px-5 py-4 border-b border-slate-100 bg-slate-50 dark:bg-slate-900 dark:border-slate-800 flex items-center justify-between">
                      <div>
                        <h3 className="font-bold text-xs text-slate-800 dark:text-slate-200 uppercase tracking-wider flex items-center gap-1.5">
                          <Truck className="w-4 h-4 text-accent" /> Permintaan Transfer Multi-Barang
                          Antar Cabang
                        </h3>
                        <p className="text-[10px] text-slate-400 mt-0.5">
                          Pilih cabang pengirim & penerima, lalu tambahkan barang yang ingin
                          dipindahkan.
                        </p>
                      </div>
                    </div>
                    <div className="p-5 space-y-5 text-xs">
                      ...
                      {selectedTrfFromWarehouse ? (
                        <div className="space-y-3">
                          ...
                          {bulkTrfItems.length === 0 ? (
                            <div className="border border-dashed border-slate-200 rounded-xl p-6 text-center text-slate-400 dark:border-slate-800">
                              Belum ada produk ditambahkan. Gunakan tombol di atas atau paste bulk
                              di sebelah kanan untuk menambahkan.
                            </div>
                          ) : (
                        ...
                        <div className="bg-slate-50 dark:bg-slate-900 p-6 rounded-xl border border-dashed border-slate-200 dark:border-slate-700 text-center text-slate-400">
                          Pilih Gudang Pengirim terlebih dahulu untuk mulai menambahkan barang &
                          memvalidasi stok real-time.
                        </div>
                      )}
                      ...
                      <div className="flex justify-end pt-2">
                        ...
                        >
                          <Truck className="w-4 h-4" /> Kirim Pengajuan Transfer (
                          {bulkTrfItems.length} Produk)
                        </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white border border-slate-200 rounded-xl shadow-xs p-5 space-y-4 dark:bg-slate-900 dark:border-slate-800">
                    <div>
                      <h4 className="font-bold text-xs text-slate-800 dark:text-slate-200 uppercase tracking-wider flex items-center gap-1.5">
                        <FileSpreadsheet className="w-4 h-4 text-emerald-600" /> Upload / Paste Data
                        Mutasi Bulk
                      </h4>
                      <p className="text-[10px] text-slate-400 mt-0.5">
                        Masukkan baris data SKU produk dan kuantiti secara cepat (cocok copy-paste
                        dari Excel).
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-3.5 space-y-2 text-[10px] text-slate-500">
                      ...
                      <ul className="list-disc pl-4 space-y-1">
                        <li>
                          Pilih Gudang Pengirim terlebih dahulu sebelum menekan tombol parse agar
                          sistem dapat memvalidasi stok.
                        </li>
                        <li>
                          Jika SKU valid dan stok tersedia di gudang pengirim, barang akan
                          ditambahkan ke tabel draft di kiri.
                        </li>
                    ...
                    <div className="relative flex justify-between">
                      ...
                      <div className="flex flex-col items-center text-center space-y-1.5 w-[20%]">
                        ...
                        <span className="text-[8px] text-slate-400 font-mono leading-none">
                          {new Date(
                            activeTransfer.history.find((h) => h.status === 'REQUEST_CREATED')
                              ?.timestamp || ''
                          ).toLocaleTimeString()}
                        </span>
                      </div>
                        ...
                        <div className="flex gap-2">
                          ...
                          {activeTransfer.status === 'RECEIVED' && (
                            <p className="text-[11px] text-emerald-600 dark:text-emerald-400 font-bold">
                              ✓ Siklus mutasi logistik barang selesai dikonfirmasi. Stok telah
                              bertambah di cabang penerima.
                            </p>
                          )}
                        </div>
                      </div>
              ...
              <div className="bg-white border border-slate-200 rounded-xl shadow-xs overflow-hidden dark:bg-slate-900 dark:border-slate-800">
                <div className="px-5 py-4 border-b border-slate-100 bg-slate-50 dark:bg-slate-900 dark:border-slate-800 flex items-center justify-between">
                  <div>
                    <h3 className="font-bold text-xs text-slate-800 dark:text-slate-200 uppercase tracking-wider flex items-center gap-1.5">
                      <History className="w-4 h-4 text-accent" /> Buku Besar & Ledger Mutasi Antar
                      Cabang
                    </h3>
                    <p className="text-[10px] text-slate-400 mt-0.5">
                      Daftar lengkap audit trail seluruh pergerakan barang antar gudang cabang
                      beserta status pengiriman aktual.
                    </p>
                  </div>
                </div>
                ...
                <div className="responsive-table-container overflow-x-auto">
                  <table className="w-full min-w-[900px] text-left text-xs">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                      ...
                      {inventoryTransfers.filter((t) => t.tenantId === currentTenantId).length ===
                        0 && (
                        <tr>
                          <td
                            colSpan={7}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white border border-slate-200 rounded-xl shadow-xs overflow-hidden dark:bg-slate-900 dark:border-slate-800">
                  <div className="px-5 py-4 border-b border-slate-100 bg-slate-50 dark:bg-slate-900 dark:border-slate-800 flex items-center justify-between">
                    <h3 className="font-bold text-xs text-slate-800 dark:text-slate-200 uppercase tracking-wider flex items-center gap-1.5">
                      <Layers className="w-4 h-4 text-emerald-600" /> Distribusi Stok Multi-Cabang
                      Saat Ini
                    </h3>
                ...
                <div className="bg-white border border-slate-200 rounded-xl shadow-xs p-5 space-y-4 dark:bg-slate-900 dark:border-slate-800">
                  ...
                  <div className="space-y-3.5 text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                    <div className="p-3 bg-slate-50 dark:bg-slate-900 rounded-xl">
                      ...
                      <p className="mt-1">
                        <strong>Request Created</strong> (Diajukan) → <strong>Packed</strong> (Kemas
                        barang) → <strong>Shipped</strong> (Driver jalan, stok di cabang pengirim
                        langsung dipotong) → <strong>Received</strong> (Barang tiba di tujuan &
                    ...
                    <div className="p-3 bg-slate-50 dark:bg-slate-900 rounded-xl">
                      ...
                      <p className="mt-1">
                        Sistem akan melarang pengiriman jika kuantiti mutasi melebihi sisa stok
                        real-time yang terdaftar di lokasi gudang pengirim. Ini mencegah terjadinya
                        pencatatan stok negatif.
                      </p>
                    </div>
                    <div className="p-3 bg-slate-50 dark:bg-slate-900 rounded-xl">
                      <p className="font-bold text-slate-700 dark:text-slate-300">
                      ...
                      <p className="mt-1">
                        Setiap penyesuaian status pada alur pengiriman di atas akan otomatis
                        mengunci nama pengguna (operator), melampirkan timestamp lokal presisi, dan
                        mencatat mutasi stok ke sistem log audit internal untuk perlindungan aset
                        anti-fraud.
                      </p>
                    </div>
                  </div>
