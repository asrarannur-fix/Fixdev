                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-emerald-600">
                      Seluruh pengaturan ini akan diterapkan otomatis pada tindakan cetak langsung
                      (Nota QR & Label QR) di tabel tiket.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {healthStatus === 'ok'
                      ? `Sehat (${healthPrinters.length} printer)`
                      : healthStatus === 'fail'
                        ? 'Tidak Terhubung'
                        : healthStatus === 'checking'
                          ? 'Mengecek...'
                  ...
                  {printMode === 'qz' && (
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-indigo-50 text-indigo-600 hover:bg-indigo-100 transition-all disabled:opacity-50"
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 rounded-xl border border-amber-200 bg-amber-50 p-3 text-[10px] text-amber-900">
                  ...
                  <div className="mb-2">
                    Install di komputer kasir/operator. Setelah install, buka ulang browser lalu
                    pilih mode QZ Tray.
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <a
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                ...
                <div className="flex items-center justify-between p-3 border border-slate-100 bg-slate-50/50 rounded-xl">
                  <div className="space-y-0.5">
                    ...
                    <span className="text-[9px] text-slate-400 block">
                      Font lebih kecil, margin tipis, hemat kertas
                    </span>
                  </div>
                  <input
                    type="checkbox"
          ...
          <div className="xl:col-span-6 space-y-4">
            <div className="bg-slate-900 rounded-2xl p-6 border border-slate-800 text-white shadow-xl relative overflow-hidden flex flex-col items-center">
              ...
              <p className="text-[10px] text-slate-500 mt-4 leading-relaxed text-center max-w-sm">
                ...
                langsung mencetak nota fisik menggunakan konfigurasi di atas.
              </p>
            </div>
          </div>
        </>
