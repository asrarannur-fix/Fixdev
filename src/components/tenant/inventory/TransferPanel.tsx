...
import { CheckSquare, FileSpreadsheet, History, Layers, Plus, Trash2, Truck, Zap } from "lucide-react";
...
export const TransferPanel: React.FC<TransferPanelProps> = ({
  tenantProducts, warehouses, inventoryTransfers, currentTenantId, branches, products, showToast,
  createInventoryTransfer, updateInventoryTransferStatus, selectedTrfFromWarehouse, setSelectedTrfFromWarehouse,
  selectedTrfToWarehouse, setSelectedTrfToWarehouse, trfNote, setTrfNote, bulkInputText, setBulkInputText,
  bulkTrfItems, setBulkTrfItems, trfStatusNote, setTrfStatusNote, selectedTrfIdForStepper, setSelectedTrfIdForStepper,
}) => {
