...
## Domain Tenant
- Tenant memakai subdomain tunggal di bawah `TENANT_ROOT_DOMAIN`.
- Custom domain tidak didukung. Kolom lama dihapus oleh `migrations/053_tenant_infrastructure_hardening.sql`.
