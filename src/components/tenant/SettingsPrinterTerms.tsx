    ...
    <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 animate-fadeIn dark:text-zinc-300 dark:[&_.bg-white]:bg-zinc-950 dark:[&_.bg-slate-50]:bg-zinc-900 dark:[&_.border-slate-100]:border-zinc-800 dark:[&_.border-slate-200]:border-zinc-800 dark:[&_.text-slate-800]:text-zinc-100 dark:[&_.text-slate-700]:text-zinc-200 dark:[&_.text-slate-600]:text-zinc-300 dark:[&_input]:bg-zinc-950 dark:[&_input]:text-zinc-100 dark:[&_textarea]:bg-zinc-950 dark:[&_textarea]:text-zinc-100 dark:[&_select]:bg-zinc-950 dark:[&_select]:text-zinc-100 dark:[&_.hover\:bg-slate-50:hover]:bg-zinc-900">
      ...
      <div className="xl:col-span-6 space-y-6">
        ...
        {printerName ? (
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-emerald-600">
                  Seluruh pengaturan ini akan diterapkan otomatis pada tindakan cetak langsung (Nota
                  QR & Label QR) di tabel tiket.
                </p>
              </div>
            </div>
          ...
          <div className="bg-slate-50 border border-slate-200 text-slate-600 rounded-xl p-4 flex items-center justify-between shadow-sm">
            <div className="flex items-center gap-2.5">
              <div className="p-1 bg-slate-300 text-white rounded-md">
                <Check className="w-4 h-4" />
              </div>
              <div>
                <p className="text-xs font-bold">Sinkronisasi Printer & Label</p>
                <p className="text-[10px] text-slate-500">
                  Atur nama printer QZ Tray di bawah untuk mengaktifkan pencetakan otomatis.
                </p>
              </div>
            </div>
            <span className="text-[9px] font-mono bg-slate-200 text-slate-600 px-2 py-0.5 rounded font-bold uppercase">
              Belum Dikonfigurasi
            </span>
          </div>
        )}
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-bold text-xs uppercase text-slate-800">Koneksi QZ Tray</h4>
              <p className="text-[10px] text-slate-400">
                Cek aplikasi lokal dan daftar printer sebelum memakai mode otomatis.
              </p>
            </div>
            <span
              className={`text-[10px] font-bold px-2 py-1 rounded-lg ${qzStatus?.startsWith('Terhubung') ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-600'}`}
            >
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-5">
          <div className="flex items-center gap-2.5 pb-3 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400">
                Atur ukuran media, margin fisik, dan ukuran huruf kertas thermal atau HVS.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                value={printMode || 'browser'}
                onChange={(e) => savePrinterSettings({ printMode: e.target.value })}
            ...
            <div className="md:col-span-2 rounded-xl border border-amber-200 bg-amber-50 p-3 text-[10px] text-amber-900">
              ...
              <div className="mb-2">
                Install di komputer kasir/operator. Setelah install, buka ulang browser lalu pilih
                mode QZ Tray.
              </div>
              <div className="flex flex-wrap gap-2">
                <a
                ...
                >
                  <ExternalLink className="h-3 w-3" /> Download QZ Tray
                </a>
                <a
                ...
                >
                  <Download className="h-3 w-3" /> Setup Otomatis Windows 7+
                </a>
              </div>
              <span className="block mt-2">
                QZ Tray harus tetap berjalan saat mencetak. Installer perlu dijalankan sebagai
                Administrator.
              </span>
            </div>
            <div>
              ...
              >
                <option value="thermal_58">Thermal 58 mm (Kertas Struk Mini)</option>
                <option value="thermal_80">Thermal 80 mm (Kertas Struk Kasir Standar)</option>
                <option value="hvs_a4">HVS A4 (Faktur Service Lipat/Penuh)</option>
                <option value="hvs_letter">HVS Letter (Faktur Standar)</option>
              </select>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-slate-200 bg-white rounded-xl text-xs outline-none focus:border-accent cursor-pointer transition-all font-semibold"
              >
                <option value="sm">Kecil (Maksimum Kepadatan / Eco-Print)</option>
                <option value="base">Sedang / Default (Sangat Direkomendasikan)</option>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
            <div className="flex items-center justify-between p-3 border border-slate-100 bg-slate-50/50 rounded-xl">
              <div className="space-y-0.5">
                <span className="text-xs font-bold text-slate-700 block">Cetak QR Code Lacak</span>
              ...
              <input
                type="checkbox"
                checked={printQrCode}
                onChange={(e) => savePrinterSettings({ printQrCode: e.target.checked })}
            ...
            <div className="flex items-center justify-between p-3 border border-slate-100 bg-slate-50/50 rounded-xl">
              <div className="space-y-0.5">
                <span className="text-xs font-bold text-slate-700 block">Cetak Keluhan Unit</span>
                <span className="text-[9px] text-slate-400 block">
          ...
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400">
                  Atur dimensi stiker, font, and informasi pada label identifikasi.
                </p>
              </div>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center justify-between p-2.5 border border-slate-100 bg-slate-50/50 rounded-xl">
              <div className="space-y-0.5">
                ...
                <span className="text-[8px] text-slate-400 block">Sertakan header judul toko</span>
              </div>
              <input
                type="checkbox"
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => savePrinterSettings({ customHeaderTitle: e.target.value })}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => savePrinterSettings({ customFooterText: e.target.value })}
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between pb-2 border-b border-slate-100 gap-2">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400">
                  Sesuaikan klausul hukum spesifik per jenis transaksi bisnis.
                </p>
              </div>
            </div>
          </div>
          ...
          {skActiveTab === 'servis' && (
            <div className="space-y-2">
              ...
              <p className="text-[9px] text-slate-400 italic">
                Diterapkan pada Nota Bukti Penerimaan Unit Servis dan Portal Pelacakan online.
              </p>
            </div>
          )}
          ...
          {skActiveTab === 'penjualan' && (
            <div className="space-y-2">
              ...
              />
              <p className="text-[9px] text-slate-400 italic">
                Diterapkan otomatis pada pencetakan Struk / Nota penjualan kasir POS.
              </p>
            </div>
          )}
          ...
          {skActiveTab === 'penyewaan' && (
            <div className="space-y-2">
              ...
              />
              <p className="text-[9px] text-slate-400 italic">
                Diterapkan otomatis pada pencetakan Dokumen / Nota sewa harian/mingguan.
              </p>
            </div>
          )}
      ...
      <div className="xl:col-span-6 space-y-4">
        <div className="bg-slate-900 rounded-2xl p-6 border border-slate-800 text-white shadow-xl relative overflow-hidden flex flex-col items-center">
          ...
          <p className="text-[10px] text-slate-500 mt-4 leading-relaxed text-center max-w-sm">
            ...
            <strong className="text-slate-300">"Label QR"</strong> pada tabel tiket untuk langsung
            mencetak nota fisik menggunakan konfigurasi di atas.
          </p>
        </div>
      </div>
    </div>
